...
class Settings(BaseSettings):
    ...
    DB_HOST: str = EnvManager.get_str("DB_HOST", default="")
    DB_PORT: int = 5432
    DB_LOGIN: str = EnvManager.get_str("DB_LOGIN", default="")
    DB_PASSWORD: str = EnvManager.get_str("DB_PASSWORD", default="")
    DB_NAME: str = EnvManager.get_str("DB_NAME", default="")
